...
const navigation = [
  ...
  },
  {
    name: 'Planning',
    items: [
      { name: 'Planning Cycles', href: '/cycles', icon: CalendarIcon },
      { name: 'Budget Allocation', href: '/budgets', icon: BankIcon },
      { name: 'Workforce Planning', href: '/workforce', icon: UsersIcon },
      { name: 'Finance Review', href: '/workforce/review', icon: ClipboardCheckIcon },
      { name: 'Monitoring', href: '/workforce/monitoring', icon: ChartBarIcon },
    ],
  },
  {
    name: 'Organization',
    items: [
      { name: 'Job Architecture', href: '/job-architecture', icon: OrgChartIcon },
      { name: 'Positions', href: '/positions', icon: ChairIcon },
      { name: 'Departments', href: '/departments', icon: BuildingIcon },
      { name: 'Roles', href: '/roles', icon: BriefcaseIcon },
      { name: 'Employees', href: '/employees', icon: UserIcon },
      { name: 'Hiring Proposals', href: '/hiring', icon: UserPlusIcon },
    ],
  },
  {
    name: 'Compensation',
    items: [
      { name: 'Pay Grades', href: '/pay-grades', icon: ScaleIcon },
      { name: 'Comp Cycles', href: '/compensation', icon: TrendingUpIcon },
      { name: 'OPEX Tracking', href: '/expenses', icon: ReceiptIcon },
    ],
  },
  {
    name: 'Admin',
    items: [
      ...
      { name: 'Audit Log', href: '/audit', icon: ClipboardIcon },
    ],
  },
]
