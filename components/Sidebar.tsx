...
const navigation = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Headcount Plans', href: '/headcount', icon: UsersIcon },
    ],
  },
  {
    name: 'Workforce',
...
export function Sidebar() {
  ...
  return (
    <div className="flex h-full w-72 flex-col bg-gradient-to-b from-slate-900 via-slate-900 to-indigo-950">
      ...
      <div className="p-4 m-4 rounded-xl bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-white/5">
